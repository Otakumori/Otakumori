...
export declare function createRimLightShader(
  _uniforms?: Partial<RimLightShaderUniforms>,
): RimLightShader;
export declare function createOutlineShader(
  _uniforms?: Partial<OutlineShaderUniforms>,
): OutlineShader;
