 ...
 */
export declare function updateCharacter(controller: CharacterController, input: ActionState, dt: number, gravity?: Vec3): void;
/**
 * Check if character should be grounded
 */
export declare function checkGroundContact(position: Vec3, velocity: Vec3, _rayDistance?: number): boolean;
/**
 ...
 */
export declare function resolveSlopeCollision(controller: CharacterController, slopeAngle: number): void;
/**
 * Handle step offset (stairs)
 */
export declare function handleStepOffset(position: Vec3, controller: CharacterController, obstacleHeight: number): Vec3;
/**
