 ...
 */
export declare function createTransform(position?: [number, number, number], rotation?: [number, number, number, number], scale?: [number, number, number]): Transform;
/**
 * Velocity component
 */
 ...
 */
export declare function createCharacterController(options?: Partial<CharacterController>): CharacterController;
/**
