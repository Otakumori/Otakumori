...
const demo: Product[] = [
  {
    id: 'tee-void',
    title: 'Void-Petal Sakura Tee',
    image: '/media/products/void-sakura.jpg',
    priceUSD: 48,
    petalBonus: 48,
    tag: 'New',
    inStock: true,
  ...
  {
    id: 'hoodie-guardian',
    title: 'Guardian Rune Hoodie',
    image: '/media/products/guardian-hoodie.jpg',
    priceUSD: 72,
    petalBonus: 90,
    tag: 'Limited',
    inStock: true,
  ...
  {
    id: 'poster-blossom',
    title: 'Blossom Overlord Poster (A2)',
    image: '/media/products/blossom-poster.jpg',
    priceUSD: 24,
    petalPrice: 24,
    tag: 'Variant',
    inStock: true,
...
export default function ProductGrid({ products = demo }: { products?: any[] }) {
  ...
  const transformedProducts =
    products.length > 0 &&
    products[0]?.id &&
    typeof products[0].id === 'string' &&
    products[0].id.length > 10
