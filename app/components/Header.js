        ...
        <nav className="hidden md:flex space-x-8 text-white text-lg">
          ...
          <div className="relative group">
            ...
            <div className="absolute left-0 mt-2 w-52 bg-black/90 p-2 rounded-lg shadow-lg hidden group-hover:block">
              ...
              <Link href="/shop/apparel" className="block py-1 px-3 hover:bg-gray-800">
                Apparel
              </Link>
              <Link href="/shop/homedecor" className="block py-1 px-3 hover:bg-gray-800">
                Home Decor
              </Link>
              <Link href="/shop/accessories" className="block py-1 px-3 hover:bg-gray-800">
                Accessories
              </Link>
              <Link
                href="/shop/theabyss"
                className="block py-1 px-3 text-red-500 hover:bg-red-700"
              >
                The Abyss 🔞
              </Link>
            </div>
