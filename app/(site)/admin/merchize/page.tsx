    ...
    <main className="mx-auto max-w-6xl px-6 py-10 text-white">
      <div className="mb-8">
        ...
        <p className="mt-2 text-sm text-white/70">
          Parallel integration bridge for testing Merchize inside Otakumori without disturbing the
          existing Printify flow.
        </p>
      </div>
      ...
      <section className="rounded-2xl border border-white/10 bg-black/30 p-6">
        ...
        {products.length === 0 ? (
          <p className="text-sm text-white/70">
            No products were normalized yet. If the endpoint is live, the payload shape may need one
            more mapping pass.
          </p>
        ) : (
