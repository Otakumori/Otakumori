...
const OtakuBeatEmUpGameWrapper = dynamic(() => import('./Game'), {
  ssr: false,
});
...
export default function RhythmBeatEmUpPage() {
  ...
  } = useGameAvatar('otaku-beat-em-up', {
    ...
    return (
      <MiniGameFrame gameId="otaku-beat-em-up">
        <div className="relative min-h-screen" style={backgroundStyle}>
          ...
          {isQuakeHud ? (
            <HudComponent {...hudProps} petals={petalBalance} gameId="otaku-beat-em-up" />
          ) : (
            <HudComponent
              {...hudProps}
              score={score}
          ...
          <GameShell title={displayName} gameKey="rhythm-beat-em-up">
            <div className="w-full h-full flex flex-col items-center justify-center bg-gradient-to-br from-purple-900 via-pink-800 to-red-900 p-4">
              ...
              {gameState === 'playing' && selectedMode && (
                <OtakuBeatEmUpGameWrapper mode={selectedMode} />
              )}
            </div>
          </GameShell>
            ...
            <div className="max-w-4xl w-full">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                >
                  ...
                  <p className="text-purple-200 text-sm">
                    Classic beat-em-up action with rhythm scoring. Chain combos and maintain the
                    beat!
                  </p>
                  <div className="mt-4 text-yellow-300 text-xs">
              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-zinc-200">
                  <div>
                    <span className="text-pink-400 font-bold">WASD / Arrows:</span> Move your
                    character
                  </div>
                  <div>
                ...
                <p className="text-center text-xs text-pink-300 mt-4">
                  Attack in sync with the beat indicators at the top-right for maximum damage and
                  combo bonuses!
                </p>
              </motion.div>
            </div>
