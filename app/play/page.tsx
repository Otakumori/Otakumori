      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
          {DEMO_ASSETS.map((asset) => (
            ...
            >
              ...
              <p className="text-sm text-slatey-400 mb-3">{asset.description}</p>
        ...
        {selectedAsset && (
          <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-6 mb-8">
            <div className="flex items-start justify-between mb-4">
              <h2 className="text-2xl font-bold text-slatey-200">{selectedAsset.name}</h2>
              <button
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              {/* Asset Details */}
              <div>
                <p className="text-slatey-300 mb-4">{selectedAsset.description}</p>
        ...
        <div className="text-center bg-slate-800/30 border border-slate-700 rounded-2xl p-8">
          ...
          <p className="text-slatey-400 mb-6 max-w-2xl mx-auto">
            All assets come with multiple resolutions, source files, and are ready to drop into your
            favorite game engine. No attribution required for commercial use.
          </p>
