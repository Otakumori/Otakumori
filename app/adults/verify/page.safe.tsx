          ...
          <div className="bg-white/10 backdrop-blur-lg border border-white/20 rounded-2xl p-8">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-yellow-300 text-sm">
                    Adult content may include suggestive outfits, physics simulations, and interactions. 
                    All content is tasteful and non-explicit, but may not be suitable for all audiences.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-gray-400 text-xs">
                ...
                <a href="/terms" className="text-pink-400 hover:text-pink-300 underline ml-1">Terms of Service</a> and 
                <a href="/privacy" className="text-pink-400 hover:text-pink-300 underline ml-1">Privacy Policy</a>.
              </p>
            </div>
          </div>
