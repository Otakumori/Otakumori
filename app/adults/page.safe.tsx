          ...
          <div className="flex items-start space-x-3">
            ...
            <div>
              ...
              <p className="text-yellow-300 text-sm">
                This area contains adult content and features. All content is tasteful and non-explicit, 
                but may include suggestive styling, physics, and interactions. You can control what you see 
                in the Safety Settings.
              </p>
            </div>
          </div>
        </div>
