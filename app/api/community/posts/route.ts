...
const mockPosts = [
  {
    ...
    caption: 'My first attempt at a Dark Souls cosplay! The armor took forever but totally worth it 🗡️',
    author: {
      name: 'SolaireFan',
  ...
  },
  {
    ...
    caption: 'Kill la Kill cosplay for the community meetup! The scissors were a pain to make but they turned out great ✂️',
    author: {
      name: 'RyukoCosplayer',
  ...
  },
  {
    ...
    caption: 'Bloodborne hunter cosplay! The trick weapon was challenging but so satisfying to complete 🩸',
    author: {
  ...
  },
  {
    ...
    caption: 'Finally got my hands on the exclusive Otaku-mori merch! The attention to detail is incredible ✨',
    author: {
      name: 'MerchHunter',
