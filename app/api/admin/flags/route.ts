...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const flags = [
      { id: "event_hanami", name: "Hanami Event", description: "Enable cherry blossom festival content", enabled: true, category: "events" },
      { id: "crit_rate_boost", name: "Critical Rate Boost", description: "Increase crit chance by 15%", enabled: false, category: "gameplay" },
      { id: "daily_limit_removal", name: "Remove Daily Limits", description: "Allow unlimited petal earning", enabled: false, category: "economy" },
      { id: "admin_debug_mode", name: "Admin Debug Mode", description: "Show debug tools", enabled: false, category: "admin" }
    ];
