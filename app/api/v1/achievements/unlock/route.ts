        ...
        case 'COUPON_AMOUNT':
          ...
          await db.couponGrant.create({
            data: {
              ...
              percentOff: achievement.reward.kind === 'COUPON_PERCENT' ? achievement.reward.value : undefined,
              amountOff: achievement.reward.kind === 'COUPON_AMOUNT' ? achievement.reward.value : undefined,
