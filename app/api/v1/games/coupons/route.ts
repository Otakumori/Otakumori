...
export async function GET(request: NextRequest) {
  try {
    logger.warn('Game coupons requested from:', undefined, { value: request.headers.get('user-agent') });
    ...
    logger.error('Error fetching coupons:', undefined, undefined, error instanceof Error ? error : new Error(String(error)));
