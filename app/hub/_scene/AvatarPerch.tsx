  ...
  return (
    <div className="pointer-events-none absolute left-1/2 top-0 z-[5]">
      <div ref={host} style={{ transformOrigin:"50% 100%" }}>
        <img src={imgUrl} alt="" style={{ width: 200, filter: "drop-shadow(0 8px 20px rgba(0,0,0,.5))" }} />
        <img src={shadowUrl} alt="" style={{ width: 140, opacity:.6, transform:"translate(30px, -26px)" }} />
      </div>
    </div>
  );
}
