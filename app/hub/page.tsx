...
export default function HubPage() {
  ...
  useEffect(() => {
    let playing = true;
    (async () => { try { await play("/assets/music/hub_ambience.ogg", -18); } catch { } })();
  ...
  return (
    <div className="hub-root">
      ...
      <div className="hub-topbar">
        <Link href="/" className="hub-brand">OTAKUMORI</Link>
        <div className="hub-right">
          <Link href="/achievements" className="hub-btn">Memory Card</Link>
          <Link href="/soapstones" className="hub-btn">Soapstones</Link>
          <Link href="/mini-games" className="hub-btn">Play</Link>
        </div>
      </div>
