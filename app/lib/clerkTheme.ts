export const otakumoriClerkAppearance = {
  ...
  elements: {
    ...
    formFieldInput: "h-11 rounded-xl border border-zinc-700 bg-zinc-800/80 px-4 text-zinc-100 placeholder:text-zinc-500 focus:ring-4 focus:ring-pink-500/25 focus:border-pink-500",
    formButtonPrimary: "cl-formButtonPrimary h-11 rounded-xl bg-gradient-to-r from-pink-600 to-fuchsia-700 font-bold text-white tracking-wide hover:scale-[1.02] transition",
    socialButtons: "grid grid-cols-3 gap-3 [&>button]:rounded-xl [&>button]:border [&>button]:border-zinc-700 [&>button]:bg-zinc-800/80 [&>button:hover]:bg-zinc-700/80",
