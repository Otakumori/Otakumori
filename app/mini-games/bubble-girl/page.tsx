        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <GlassCard className="overflow-hidden p-4 relative">
            ...
            {gameState === 'playing' && (
              <>
                {isQuakeHud ? (
                  <HudComponent {...hudProps} petals={petalBalance} gameId="bubble-girl" />
                ) : (
                  <HudComponent {...hudProps} score={score} combo={0} />
                )}
              </>
            )}
            <InteractiveBuddyGame
              key={key}
              mode={mode}
              ...
              <div>
                ...
                <ul className="text-sm text-zinc-300 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    ...
                    <span>
                      <strong className="text-green-400">Healing:</strong> Restore health with
                      gentle interactions (compliment, head pat)
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-0.5">•</span>
                    <span>
                      <strong className="text-blue-400">Fun:</strong> Interactive effects and
                      physics modifiers (poke, tickle, gravity, wind)
                    </span>
                  </li>
                </ul>
              </div>
              ...
              <div>
                ...
                <ul className="text-sm text-zinc-300 space-y-2">
                  ...
                  <li className="flex items-start gap-2">
                    <span className="text-blue-400 mt-0.5">•</span>
                    <span>
                      <strong>Stress Relief:</strong> Focus on destructive tools for satisfying
                      stress release
                    </span>
                  </li>
                  <li className="flex items-start gap-2">
