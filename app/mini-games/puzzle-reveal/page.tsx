      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <GlassCard className="mt-6 p-6">
          <h3 className="font-semibold text-white text-lg mb-4 flex items-center gap-2">
            <span className="text-2xl">ℹ️</span> How to Play
          </h3>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              <h4 className="font-medium text-blue-300 mb-3 text-lg">⏱️ Scoring</h4>
              <ul className="text-sm text-zinc-300 space-y-2">
                <li className="flex items-start gap-2">
            ...
            <div>
              ...
              <ul className="text-sm text-zinc-300 space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>Higher difficulties = more petals per point</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-green-400 mt-0.5">•</span>
                  <span>Build combos and complete quickly to maximize rewards!</span>
                </li>
              </ul>
            </div>
          </div>
