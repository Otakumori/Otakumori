      ...
      >
        ...
        <div className="mt-4 text-center">
          <div className="text-xs text-neutral-500">
            <span className="inline-block px-2 py-1 rounded bg-neutral-800/50 border border-neutral-700 mr-2">ESC</span>
            Pause/Resume
            <span className="inline-block px-2 py-1 rounded bg-neutral-800/50 border border-neutral-700 ml-2 mr-2">H</span>
            Return to Hub
          </div>
        </div>
      </motion.div>
