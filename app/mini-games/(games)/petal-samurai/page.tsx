...
const PetalSamuraiGame = dynamic(() => import('./GameWrapper'), {
  ssr: false,
  loading: () => (
    <div className="flex items-center justify-center h-screen" style={{ backgroundColor: 'var(--color-bg-base)' }}>
      <div className="text-center">
        ...
        <p style={{ color: 'var(--color-text-secondary)' }}>Loading Petal Samurai...</p>
      </div>
    </div>
  ),
});
...
export default function PetalSamuraiPage() {
  return <PetalSamuraiGame mode="timed" difficulty="normal" />;
}
