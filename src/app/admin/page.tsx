    ...
    const checkAuth = async () => {
      try {
        ...
        const [
          ...
          supabase.from('soapstone_messages')
            .select('content')
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-400 mt-2">Welcome to your domain, Your Highness</p>
          </div>
          <button
        ...
        {activeTab === 'dashboard' && (
          ...
          >
            {/* Quick Actions */}
            <div>
              <h2 className="text-2xl font-bold text-pink-400 mb-4">Quick Actions</h2>
              <QuickActions />
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-pink-500/20 hover:border-pink-500/40 transition-colors">
        ...
        {activeTab === 'users' && (
          ...
          >
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-pink-500/20">
              <h2 className="text-xl font-semibold text-pink-400 mb-4">User Management</h2>
              <p className="text-gray-400">Coming soon: User management tools, permissions, and more!</p>
            </div>
          </motion.div>
        )}
        ...
        {activeTab === 'settings' && (
          ...
          >
            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg border border-pink-500/20">
              <h2 className="text-xl font-semibold text-pink-400 mb-4">Site Settings</h2>
              <p className="text-gray-400">Coming soon: Site configuration, theme settings, and more!</p>
            </div>
          </motion.div>
        )}
      </div>
