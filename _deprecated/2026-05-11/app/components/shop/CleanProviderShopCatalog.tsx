...
export default function CleanProviderShopCatalog() {
  ...
  if (loading) {
    return <div className="text-zinc-300">Loading clean storefront...</div>;
  }

  if (error) {
    return (
      <div className="rounded-2xl border border-red-500/20 bg-red-500/10 p-6 text-red-200">
        <h2 className="text-xl font-semibold mb-2">Unable to load clean storefront</h2>
        <p>{error}</p>
      </div>
    );
  }
