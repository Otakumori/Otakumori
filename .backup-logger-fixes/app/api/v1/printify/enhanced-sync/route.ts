...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.warn('Starting enhanced Printify sync...', { validateLinks, fullSync });
    ...
    logger.warn('Enhanced Printify sync completed:', result);
    ...
    logger.error('Enhanced Printify sync failed:', error);
