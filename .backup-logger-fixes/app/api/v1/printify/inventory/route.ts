...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.warn('Printify inventory sync requested from:', request.headers.get('user-agent'));
    ...
    logger.error('Inventory sync API error:', error);
...
export async function GET(request: NextRequest) {
  try {
    ...
    logger.warn('Printify inventory status requested from:', request.headers.get('user-agent'));
    ...
    logger.error('Inventory status API error:', error);
