...
export async function POST(req: NextRequest) {
  try {
    ...
    logger.error('[Printify] Order submission failed:', error);
    ...
    try {
      ...
      logger.error('[Printify] Failed to log error to database:', dbError);
    }
...
export async function GET(req: NextRequest) {
  try {
    ...
    logger.error('[Printify] Failed to get order sync status:', error);
    return NextResponse.json(
      {
        ok: false,
