...
function ProductPage({ params }) {
  ...
  const [selectedVariant, setSelectedVariant] = (0, react_1.useState)(product.variants[0]);
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-2">
            ...
            <div className="grid grid-cols-3 gap-4">
              {product.images.map((image, index) => (
                <button
                  ...
                  className={`relative h-24 overflow-hidden rounded-lg ${selectedImage === index ? 'ring-2 ring-pink-500' : ''}`}
                >
                  <image_1.default
                    src={image}
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4">
              ...
              >
                <lucide_react_1.ShoppingCart className="mr-2 h-5 w-5" />
                Add to Cart
              </button_1.Button>
              <button_1.Button
                variant="outline"
