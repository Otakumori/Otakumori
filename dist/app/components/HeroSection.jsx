...
const HeroSection_module_css_1 = __importDefault(require('./HeroSection.module.css'));
  ...
  return (
    <section className="flex items-center justify-center py-12">
      <div className="relative aspect-[2/1] w-full max-w-3xl overflow-hidden rounded-3xl shadow-xl">
        ...
        <div className={HeroSection_module_css_1.default.petalOverlay} aria-hidden="true" />
