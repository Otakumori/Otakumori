...
exports.default = PetalGameImage;
const react_1 = require('react');
const supabaseClient_1 = require('../../lib/supabaseClient');
const react_tsparticles_1 = __importDefault(require('react-tsparticles'));
...
function PetalGameImage() {
  const containerRef = (0, react_1.useRef)(null);
  const [userPetals, setUserPetals] = (0, react_1.useState)(0);
  const [globalPetals, setGlobalPetals] = (0, react_1.useState)(0);
  const [lastCollectDate, setLastCollectDate] = (0, react_1.useState)('');
  const [limitReached, setLimitReached] = (0, react_1.useState)(false);
  const [achievement, setAchievement] = (0, react_1.useState)(null);
  // Daily reset logic
  (0, react_1.useEffect)(() => {
  ...
  const handlePetalClick = (0, react_1.useCallback)(
    event => {
