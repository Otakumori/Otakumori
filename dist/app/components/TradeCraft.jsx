...
exports.default = TradeCraft;
const react_1 = require('react');
function TradeCraft() {
  const [inventory, setInventory] = (0, react_1.useState)([
    {
      id: 'petal_common',
      name: 'Common Petal',
  ...
  const [activeTab, setActiveTab] = (0, react_1.useState)('inventory');
  const [showNotification, setShowNotification] = (0, react_1.useState)(null);
  (0, react_1.useEffect)(() => {
  ...
  return (
    <div className="mx-auto w-full max-w-4xl p-6">
      ...
      <div className="mb-6 flex gap-4">
        {['inventory', 'crafting', 'trading'].map(tab => (
          <button
            key={tab}
