...
const Card = React.forwardRef(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={(0, utils_1.cn)('bg-card text-card-foreground rounded-xl border shadow', className)}
    {...props}
  />
));
exports.Card = Card;
...
const CardDescription = React.forwardRef(({ className, ...props }, ref) => (
  <p ref={ref} className={(0, utils_1.cn)('text-muted-foreground text-sm', className)} {...props} />
));
