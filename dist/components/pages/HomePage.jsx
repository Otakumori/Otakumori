...
const InteractiveCherryBlossom_1 = __importDefault(
  require('@/components/animations/InteractiveCherryBlossom')
);
      ...
      <footer className="bg-black py-6 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="mb-4 flex justify-center space-x-6 text-sm">
            <link_1.default href="/" className="hover:text-pink-500">
              Home
            </link_1.default>
            <link_1.default href="/shop" className="hover:text-pink-500">
              Shop
            </link_1.default>
            <link_1.default href="/blog" className="hover:text-pink-500">
              Blog
            </link_1.default>
            <link_1.default href="/mini-games" className="hover:text-pink-500">
              Mini-Games
            </link_1.default>
            <link_1.default href="/my-account" className="hover:text-pink-500">
              My Account
            </link_1.default>
            <link_1.default href="/community" className="hover:text-pink-500">
              Community
            </link_1.default>
          </div>

          <p className="text-lg font-bold text-gray-400">Otaku-mori</p>
          <p className="mb-4 text-sm text-gray-500">Stay a while. Let's blossom together. 🌸</p>

          <div className="mb-2 flex justify-center space-x-4 text-sm text-gray-500">
            <link_1.default href="/contact" className="hover:text-pink-500">
              Contact Us
            </link_1.default>
          </div>

          <p className="text-xs text-gray-600">
            &copy; {new Date().getFullYear()} Otaku-mori. Made with ❤️
          </p>
        </div>
      </footer>
    </main>
