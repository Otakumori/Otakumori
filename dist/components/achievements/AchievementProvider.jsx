...
exports.AchievementProvider = exports.useAchievements = void 0;
const react_1 = __importStar(require('react'));
const AchievementContext = (0, react_1.createContext)(undefined);
const useAchievements = () => {
  const ctx = (0, react_1.useContext)(AchievementContext);
...
const AchievementDrawer = () => {
  const { achievements, isOpen, closeAchievements, removeAchievement, clearAchievements } = (0,
  exports.useAchievements)();
  return (
    <div
      className={`fixed right-0 top-0 z-50 h-full w-96 max-w-full transform border-l border-blue-200 bg-gradient-to-br from-blue-100/90 to-indigo-200/90 shadow-2xl transition-transform duration-300 ease-in-out ${isOpen ? 'translate-x-0' : 'translate-x-full'} backdrop-blur-lg`}
