...
const metricsCollector = spawn('node', [
  path.join(__dirname, 'start-metrics-collector.js')
], {
  stdio: 'inherit',
  env: {
    ...process.env,
...
const healthChecker = spawn('node', [
  path.join(__dirname, 'start-health-check.js')
], {
  stdio: 'inherit',
  env: {
    ...process.env,
...
const logScheduler = spawn('node', [
  path.join(__dirname, 'cron-logs.js')
], {
  stdio: 'inherit',
  env: {
    ...process.env,
