...
function fixHooksWarnings(content, filePath) {
  ...
  content = content.replace(
    ...
    (match, body) => {
      ...
      const filteredVars = usedVars.filter(v => 
...
function fixImgWarnings(content, filePath) {
  ...
  if (filePath.includes('/game') || filePath.includes('/scene') || filePath.includes('/sprite') || 
      filePath.includes('/mini-games') || filePath.includes('/abyss')) {
