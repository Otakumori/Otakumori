      ...
      {backlog.length > 0 && (
        <>
          <div className="mt-6 pt-4 border-t border-slate-700">
            <h4 className="text-slatey-200 mb-3 font-medium">
    ...
    <li className="rounded-xl border border-slate-700 bg-cube-900/80 p-3">
      <div className="flex items-center justify-between mb-2">
        <div className="flex-1">
          ...
          <div className="text-xs text-slatey-400 mt-1">
        ...
        <div className="text-right">
          ...
          {bonusReward > 0 && (
            <div className="text-xs text-sakura-400">
              +{bonusReward} bonus
            </div>
          )}
        </div>
      ...
      <div className="mt-3 flex items-center justify-between">
        ...
        >
          {claiming ? 'Claiming...' : 
           assignment.claimedAt ? 'Claimed ✓' : 
           canClaim ? 'Claim Petals' : 
           `${assignment.progress}/${assignment.target}`
          }
        </button>
      </div>
