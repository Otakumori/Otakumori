...
export function InsidersSignup() {
  ...
  if (isSubmitted) {
    return (
      <section
        id="insiders-signup"
        className="bg-gradient-to-br from-purple-600 via-pink-600 to-indigo-600 py-20 relative overflow-hidden"
      >
        {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-12 max-w-3xl text-xl text-purple-100 leading-relaxed">
            Beyond the veil of the ordinary lies a realm where cherry blossoms whisper secrets and
            pixel art holds ancient wisdom.
            <span className="block mt-3 text-lg text-purple-200">
              Join the chosen few who receive early access to drops, hidden petals, and exclusive
              content that exists only in the digital shrine.
            </span>
          </p>
