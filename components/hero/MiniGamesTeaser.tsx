...
export function MiniGamesTeaser() {
  return (
    <section id="mini-games-teaser" className="bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-900 py-20 relative overflow-hidden">
      {/* Background pattern */}
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="mb-16 text-center">
          ...
          <p className="mx-auto max-w-3xl text-xl text-purple-100 leading-relaxed">
            Where cherry blossoms meet pixel art. Test your skills, collect petals, and unlock hidden treasures in our pixel-perfect mini-games. 
