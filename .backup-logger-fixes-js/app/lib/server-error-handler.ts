...
export function handleServerError(
  ...
  try {
    ...
    if (typeof console !== 'undefined' && console.error) {
      logger.error('[handleServerError] Failed to track error in Sentry:', sentryError);
    }
  }
  ...
  try {
    ...
    if (typeof console !== 'undefined' && console.error) {
      logger.error('[handleServerError] Failed to log error:', loggerError);
      logger.error('[handleServerError] Original error:', errorDetails);
    }
  }
