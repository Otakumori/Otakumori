...
export const QUALIFIERS = ["beware!","ahead","backstepping","good luck","well done!","if only I had one","don't you dare!","praise it!","try two-handing","behold!"];
export const BLOCKLIST = ["slur1","slur2","nsfwword"]; // extend
