...
export const env = createEnv({
  ...
  server: {
    ...
    MERCHIZE_API_URL: z.string().url().optional(),
    MERCHIZE_STORE_API_URL: z.string().url().optional(),
    MERCHIZE_ACCESS_TOKEN: z.string().optional(),
    MERCHIZE_API_TOKEN: z.string().optional(),
    MERCHIZE_WEBHOOK_SECRET: z.string().optional(),
    MERCHIZE_LOCAL_IMPORT_ENABLED: z.string().optional(),
    ...
    LIGHTHOUSE_CI: z.string().optional(),
  ...
  client: {
    ...
    NEXT_PUBLIC_MERCHIZE_API_URL: z.string().url().optional(),
    // Feature flags
  ...
  runtimeEnv: {
    ...
    MERCHIZE_API_URL: process.env.MERCHIZE_API_URL,
    MERCHIZE_STORE_API_URL: process.env.MERCHIZE_STORE_API_URL,
    MERCHIZE_ACCESS_TOKEN: process.env.MERCHIZE_ACCESS_TOKEN,
    MERCHIZE_API_TOKEN: process.env.MERCHIZE_API_TOKEN,
    MERCHIZE_WEBHOOK_SECRET: process.env.MERCHIZE_WEBHOOK_SECRET,
    MERCHIZE_LOCAL_IMPORT_ENABLED: process.env.MERCHIZE_LOCAL_IMPORT_ENABLED,
    ...
    CI: process.env.CI,
    LIGHTHOUSE_CI: process.env.LIGHTHOUSE_CI,
    ...
    // Petal discount vouchers
    PETAL_DISCOUNT_ENABLED: process.env.PETAL_DISCOUNT_ENABLED,
    PETAL_DISCOUNT_MIN_ORDER_CENTS: process.env.PETAL_DISCOUNT_MIN_ORDER_CENTS,
    ...
    NEXT_PUBLIC_MERCHIZE_API_URL: process.env.NEXT_PUBLIC_MERCHIZE_API_URL,
    ...
    NEXT_PUBLIC_FEATURE_HOMEPAGE_EXPERIMENTAL_ENABLED:
