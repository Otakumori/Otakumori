...
export const env = createEnv({
  ...
  server: {
    ...
    STRIPE_WEBHOOK_FULFILLMENT_DRY_RUN: z.string().optional(),
    FULFILLMENT_PROVIDER: z.enum(['printify', 'merchize', 'manual', 'disabled']).optional(),
    FULFILLMENT_DRY_RUN: z.string().optional(),
